...
addContact(): demande les infos, remplit un contact, gère l’index

displayListContacts(): affiche la liste formatée (index, prénom, nom, nickname)

displayContact(int index): affiche un contact en détail
*/
